...
const whiteboard = {
  ...
  getWhiteboard: function (whiteboardContainer, newSettings) {
  ...
  handleEventsAndData: function (content, isNewData, doneCallback) {
    ...
    window.requestAnimationFrame(function () {
      if (tool === "line" || tool === "pen") {
        ...
        _this.dragCanvasRectContent(data[0], data[1], data[2], data[3], data[4], data[5], true);
        ...
        if (content["draw"] == "1") {
          ...
          _this.drawImgToBackground(content["url"], data[0], data[1], data[2], data[3], data[4]);
        }
